                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_card_title, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(__props.toUpdate ? "\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0641\u0631\u0632" : "\u0627\u0636\u0627\u0641\u0629 \u0641\u0631\u0632 \u062C\u062F\u064A\u062F")}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(__props.toUpdate ? "\u062A\u0639\u062F\u064A\u0644 \u0627\u0644\u0641\u0631\u0632" : "\u0627\u0636\u0627\u0641\u0629 \u0641\u0631\u0632 \u062C\u062F\u064A\u062F"), 1)
                        ];
                      }
                    }),
                    _: 1
                                  ...
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_v_col, { cols: "12" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="field_container"${_scopeId6}><label for="typeName"${_scopeId6}>\u0627\u0633\u0645 \u0646\u0648\u0639 \u0627\u0644\u0645\u0646\u062A\u062C</label><div class="input_parent position-relative"${_scopeId6}><input type="text"${ssrRenderAttr("value", unref(data).name)} placeholder="\u0627\u0633\u0645 \u0646\u0648\u0639 \u0627\u0644\u0645\u0646\u062A\u062C" name="typeName" id="typeName" class="${ssrRenderClass(
                                          ...
                                          return [
                                            createVNode("div", { class: "field_container" }, [
                                              createVNode("label", { for: "typeName" }, "\u0627\u0633\u0645 \u0646\u0648\u0639 \u0627\u0644\u0645\u0646\u062A\u062C"),
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/product_types/Update.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_v_row = resolveComponent("v-row");
      const _component_v_col = resolveComponent("v-col");
      const _component_product_types_update = __nuxt_component_0$1;
      ...
      _push(ssrRenderComponent(_component_v_container, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(unref(VDataTableServer), {
                            ...
                            items: __props.productTypes.content,
                            loading: __props.loading,
                            "items-per-page": unref(perPage),
                            "onUpdate:itemsPerPage": ($event) => isRef(perPage) ? perPage.value = $event : null,
                            page: unref(page),
                            "onUpdate:page": ($event) => isRef(page) ? page.value = $event : null,
                            "items-length": __props.productTypes.totalElements ? __props.productTypes.totalElements : 0,
            ...
            return [
              __props.productTypes ? (openBlock(), createBlock(_component_v_row, {
                key: 0,
                class: "px-4"
              }, {
                default: withCtx(() => [
      ...
      if (unref(openUpdate)) {
        _push(ssrRenderComponent(_component_product_types_update, {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/product_types/Listing.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ProductTypesListing = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "dashboard_tests_page mb-10" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_ProductTypesListing, {
        productTypes: unref(productTypes),
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product_types/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-d3b32568.mjs.map
