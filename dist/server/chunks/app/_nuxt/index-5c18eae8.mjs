...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/reports/clients/payments/Filter.vue");
                    ...
                    _push3(ssrRenderComponent(_component_v_table, { class: "text-center w-100" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(`<!--]--><tfoot${_scopeId3}><tr class="pt-5"${_scopeId3}><td style="${ssrRenderStyle({ "font-weight": "bold", "font-size": "18px" })}"${_scopeId3}>\u0627\u0644\u0627\u062C\u0645\u0627\u0644\u064A</td><td style="${ssrRenderStyle({ "font-weight": "bold", "font-size": "18px" })}"${_scopeId3}>${ssrInterpolate(unref(totalDues))}</td><td${_scopeId3}></td></tr><tr${_scopeId3}><td${_scopeId3}></td><td${_scopeId3}><div class="field_container pt-5"${_scopeId3}><div class="input_parent"${_scopeId3}><input style="${ssrRenderStyle({ "width": "100%" })}" placeholder="\u0642\u0645 \u0628\u0627\u062F\u062E\u0627\u0644 \u0645\u0628\u0644\u063A \u0627\u0644\u0633\u062F\u0627\u062F" type="text"${ssrRenderAttr("value", unref(data).paymentAmount)} class="${ssrRenderClass([
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/reports/clients/payments/PayNow.vue");
...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_v_row = resolveComponent("v-row");
      const _component_v_col = resolveComponent("v-col");
      const _component_ReportsClientsPaymentsFilter = __nuxt_component_0$1;
      const _component_v_chip = resolveComponent("v-chip");
      const _component_ReportsClientsPaymentsPayNow = __nuxt_component_1;
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_v_col, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_ReportsClientsPaymentsFilter, {
                            class: "mb-7",
                            loading: __props.loading,
                            onFilterData: ($event) => (selectedGranary.value = $event.granaryId, selected.value = [], emits("filterData", $event)),
                            reFilter: unref(reFilter),
                            onRefiltered: ($event) => (reFilter.value = false, selected.value = [])
                          }, null, _parent4, _scopeId3));
                        } else {
                          return [
                            createVNode(_component_ReportsClientsPaymentsFilter, {
                              class: "mb-7",
                              loading: __props.loading,
                              onFilterData: ($event) => (selectedGranary.value = $event.granaryId, selected.value = [], emits("filterData", $event)),
                              reFilter: unref(reFilter),
                              onRefiltered: ($event) => (reFilter.value = false, selected.value = [])
                            }, null, 8, ["loading", "onFilterData", "reFilter", "onRefiltered"])
                          ];
                        }
                      }),
                      _: 1
                        ...
                        if (_push4) {
                                ...
                                if (item.selectable.isFullPayed) {
                                  _push5(ssrRenderComponent(_component_v_chip, {
                                    ...
                                    default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                      if (_push6) {
                                        _push6(`\u0645\u062F\u0641\u0648\u0639 \u0628\u0627\u0644\u0643\u0627\u0645\u0644`);
                                      } else {
                                        return [
                                          createTextVNode("\u0645\u062F\u0641\u0648\u0639 \u0628\u0627\u0644\u0643\u0627\u0645\u0644")
                                        ];
                                      }
                                    }),
                                    _: 2
                          ...
                          return [
                            createVNode(unref(VDataTableServer), {
                              ...
                              _: 2
                            }, 1032, ["headers", "items", "loading", "items-per-page", "onUpdate:itemsPerPage", "modelValue", "onUpdate:modelValue", "page", "onUpdate:page", "items-length", "show-select"]),
      ...
      if (unref(openPopup)) {
        _push(ssrRenderComponent(_component_ReportsClientsPaymentsPayNow, {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/reports/clients/payments/Invoices.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getData = async (page, limit, filters) => {
      ...
      await clientModule.doGetClientInvoices(page - 1, limit, filtersData.value);
      loading.value = false;
    };
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ReportsClientsPaymentsInvoices = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "dashboard_clients_payments mb-10" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_ReportsClientsPaymentsInvoices, {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/reports/clients_dues/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-5c18eae8.mjs.map
