import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, version as version$1, ref, watchEffect, watch, toRaw, isRef, isReactive, toRef, warn, defineComponent as defineComponent$1, computed, unref, provide, shallowRef, createVNode, mergeProps, Transition, toRefs, nextTick, withDirectives, Fragment, resolveDirective, Text, onScopeDispose, vShow, reactive, Teleport, cloneVNode, createTextVNode, capitalize, h, vModelText, camelize, readonly, TransitionGroup, resolveDynamicComponent, effectScope, createApp, useSSRContext, getCurrentScope, onErrorCaptured, onServerPrefetch, shallowReactive, isReadonly, markRaw, defineAsyncComponent, isShallow, resolveComponent, withCtx, toDisplayString, Suspense } from 'vue';
...
import { a as useRuntimeConfig$1 } from '../nitro/firebase.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-5e5c18b6.mjs').then((m) => m.default || m)
  },
  {
    name: "clients_dues",
    path: "/clients_dues",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0da3411a.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-867d59bb.mjs').then((m) => m.default || m)
  },
  {
    name: "granary",
    path: "/granary",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-79c9c3a4.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-b2780888.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-4b9c42ad.mjs').then((m) => m.default || m)
  },
  {
    name: "product_types",
    path: "/product_types",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d3b32568.mjs').then((m) => m.default || m)
  },
  {
    name: "product_units",
    path: "/product_units",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-9ec25d17.mjs').then((m) => m.default || m)
  },
  {
    name: "products",
    path: "/products",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-89e22eab.mjs').then((m) => m.default || m)
  },
  {
    name: "reports-clients_dues",
    path: "/reports/clients_dues",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-5c18eae8.mjs').then((m) => m.default || m)
  },
  {
    name: "reports",
    path: "/reports",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-373a4f00.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-cfb6ac7c.mjs').then((m) => m.default || m)
  },
  {
    name: "reports-supplier_dues",
    path: "/reports/supplier_dues",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a45191c2.mjs').then((m) => m.default || m)
  },
  {
    name: "reports-suppliers_payments",
    path: "/reports/suppliers_payments",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-238f545b.mjs').then((m) => m.default || m)
  },
  {
    name: "signin",
    path: "/signin",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-fed15f04.mjs').then((m) => m.default || m)
  },
  {
    name: "suppliers",
    path: "/suppliers",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-e14b4807.mjs').then((m) => m.default || m)
  },
  {
    name: "suppliers_payments",
    path: "/suppliers_payments",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-b7feec3d.mjs').then((m) => m.default || m)
  },
  {
    name: "taxes",
    path: "/taxes",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-f6426b50.mjs').then((m) => m.default || m)
  }
];
...
const emitter_eH7MaP8C1y = /* @__PURE__ */ defineNuxtPlugin(() => {
  const emitter = mitt();
  return {
    provide: {
      event: emitter.emit,
...
const layouts = {
  "app-side-drawer": () => import('./_nuxt/AppSideDrawer-6f452c96.mjs').then((m) => m.default || m),
  "dashboard-nav": () => import('./_nuxt/DashboardNav-2e3a9449.mjs').then((m) => m.default || m),
  default: () => import('./_nuxt/default-ff75537f.mjs').then((m) => m.default || m)
};
...
const mainStore = defineStore("mainStore", {
  ...
  actions: {
    ...
    async doDeleteItem(url, id) {
      let result;
      await axios.delete(`${this.apiURL}/FutureLab/${url}/${id}`).then((res) => {
        result = true;
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_snackbar, {
        ...
        vertical: "",
        color: unref(callColor) == 1 ? "green" : "red",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="pb-2" style="${ssrRenderStyle({ "font-size": "20px", "font-weight": "500" })}"${_scopeId}>${ssrInterpolate(unref(callColor) == 1 ? "طلب مكتمل" : "طلب غير مكتمل")}</div><p style="${ssrRenderStyle({ "font-size": "17px" })}" class="mt-4"${_scopeId}>${ssrInterpolate(unref(callMsg))}</p>`);
          } else {
            return [
              createVNode("div", {
                class: "pb-2",
                style: { "font-size": "20px", "font-weight": "500" }
              }, toDisplayString(unref(callColor) == 1 ? "طلب مكتمل" : "طلب غير مكتمل"), 1),
              createVNode("p", {
                style: { "font-size": "17px" },
                class: "mt-4"
              }, toDisplayString(unref(callMsg)), 1)
            ];
          }
        }),
        _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-9800159e.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-d405603d.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-90299e47.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { VCheckboxBtn as A, VIcon as B, defineComponent as C, getPropertyFromItem as D, makeVTableProps as E, makeFilterProps as F, useFilter as G, provideDefaults as H, IconValue as I, VTable as J, makeDimensionProps as K, LoaderSlot as L, makeElevationProps as M, makeThemeProps as N, useDimension as O, useElevation as P, provideTheme as Q, useRoute as R, useCookie as S, useNuxtApp as T, VSelect as V, useHead as a, useProxiedModel as b, createError as c, defineStore as d, entry$1 as default, getCurrentInstance as e, deepEqual as f, getObjectValueByPath as g, clamp as h, useLocale as i, isEmpty as j, genericComponent as k, VBtn as l, mainStore as m, navigateTo as n, defineFunctionalComponent as o, propsFactory as p, convertToUnit as q, createRange as r, storeToRefs as s, consoleWarn as t, useRouter$1 as u, makeLoaderProps as v, wrapInArray as w, useLoader as x, useBackgroundColor as y, useRender as z };
