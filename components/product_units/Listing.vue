<template>
  <div class="dashboard_banners_listing">
    ...
    <v-container class="page_container" fluid>
      <v-row v-if="productUnits" class="px-4">
        <v-col
          cols="12"
          class="section_container dashboard_table pa-0"
          id="printable"
        >
          <h1 dir="rtl" class="my-2 hide_till_print">وحدات الفوارغ</h1>
          <v-data-table-server
            :headers="headers"
            ...
            v-model:page="page"
            :items-length="
              productUnits.totalElements ? productUnits.totalElements : 0
            "
...
// Props
const props = defineProps(["productUnits", "loading"]);
